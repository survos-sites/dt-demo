 ...
 */
final class Version20250722144527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jeopardy ADD comments TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE jeopardy DROP show');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jeopardy ADD show INT NOT NULL');
        $this->addSql('ALTER TABLE jeopardy DROP comments');
    }
}
